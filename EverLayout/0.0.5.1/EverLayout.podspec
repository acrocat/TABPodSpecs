#
#  Be sure to run `pod spec lint EverLayout.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "EverLayout"
  s.version      = "0.0.5.1"
  s.summary      = "An AutoLayout solution for iOS"
  ...
  # Or just: s.author    = "Dale Webster"
  # s.authors            = { "Dale Webster" => "email@address.com" }
  # s.social_media_url   = "http://twitter.com/Dale Webster"
